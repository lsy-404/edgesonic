      ...
      >
        <header class="message-center-header">
          ...
          <div class="message-center-header-actions">
            <FluentButton v-if="activeView === 'compose'" type="button" class="message-center-refresh" :aria-label="t('messages.backToInbox')" :title="t('messages.backToInbox')" @click="activeView = 'inbox'"><Icon name="left" /></FluentButton>
            <FluentButton v-else-if="props.canManageUsers" type="button" class="message-center-refresh" :aria-label="t('messages.send')" :title="t('messages.send')" @click="openComposer"><Icon name="edit" /></FluentButton>
            <FluentButton v-if="activeView === 'inbox'" type="button" class="message-center-refresh" :disabled="loading" :aria-label="t('messages.refresh')" :title="t('messages.refresh')" @click="refresh"><Icon name="refresh" /></FluentButton>
            <FluentButton type="button" class="message-center-close" :aria-label="t('common.close')" @click="closeCenter"><Icon name="cross" /></FluentButton>
          </div>
        </header>
          ...
          >
            ...
            <footer class="message-card-actions">
              ...
              <span class="message-card-buttons">
                <FluentButton v-if="!message.readAt" type="button" class="btn-secondary btn-sm" @click="read(message)">{{ t('messages.markRead') }}</FluentButton>
                <FluentButton type="button" class="btn-secondary btn-sm" @click="dismiss(message)">{{ t('messages.dismiss') }}</FluentButton>
              </span>
            </footer>
          </article>
        </div>
    ...
    <div v-if="modalMessage && !panelOpen" class="message-center-backdrop message-center-modal-backdrop" @click.self="acknowledgeModal">
      ...
      >
        ...
        <div class="message-modal-actions">
          <FluentButton tone="primary" type="button" class="btn-primary" @click="acknowledgeModal">{{ t('messages.acknowledge') }}</FluentButton>
        </div>
      </section>
    </div>
    </Teleport>
