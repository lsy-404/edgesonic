...
SELECT 'al-q3-wav-20260926', '平行四界Quadimension 3 (WAV)', '平行四界quadimension 3 wav', year, genre, cover_r2_key,
...
UPDATE song_masters
SET album_id = 'al-q3-wav-20260926', artist_id = (SELECT artist_id FROM song_masters WHERE id = '495'), album_artist_id = (SELECT album_artist_id FROM song_masters WHERE id = '495'), title = (SELECT title FROM song_masters WHERE id = '495'), sort_title = (SELECT sort_title FROM song_masters WHERE id = '495'), track = 1, disc = 1, genre = (SELECT genre FROM song_masters WHERE id = '495'), participants = (SELECT participants FROM song_masters WHERE id = '495'), lyrics = (SELECT lyrics FROM song_masters WHERE id = '495'), lyrics_rich = (SELECT lyrics_rich FROM song_masters WHERE id = '495'), cover_r2_key = (SELECT cover_r2_key FROM song_masters WHERE id = '495'), updated_at = unixepoch()
...
UPDATE song_masters
SET album_id = 'al-q3-wav-20260926', artist_id = (SELECT artist_id FROM song_masters WHERE id = '497'), album_artist_id = (SELECT album_artist_id FROM song_masters WHERE id = '497'), title = (SELECT title FROM song_masters WHERE id = '497'), sort_title = (SELECT sort_title FROM song_masters WHERE id = '497'), track = 2, disc = 1, genre = (SELECT genre FROM song_masters WHERE id = '497'), participants = (SELECT participants FROM song_masters WHERE id = '497'), lyrics = (SELECT lyrics FROM song_masters WHERE id = '497'), lyrics_rich = (SELECT lyrics_rich FROM song_masters WHERE id = '497'), cover_r2_key = (SELECT cover_r2_key FROM song_masters WHERE id = '497'), updated_at = unixepoch()
...
UPDATE song_masters
SET album_id = 'al-q3-wav-20260926', artist_id = (SELECT artist_id FROM song_masters WHERE id = '496'), album_artist_id = (SELECT album_artist_id FROM song_masters WHERE id = '496'), title = (SELECT title FROM song_masters WHERE id = '496'), sort_title = (SELECT sort_title FROM song_masters WHERE id = '496'), track = 3, disc = 1, genre = (SELECT genre FROM song_masters WHERE id = '496'), participants = (SELECT participants FROM song_masters WHERE id = '496'), lyrics = (SELECT lyrics FROM song_masters WHERE id = '496'), lyrics_rich = (SELECT lyrics_rich FROM song_masters WHERE id = '496'), cover_r2_key = (SELECT cover_r2_key FROM song_masters WHERE id = '496'), updated_at = unixepoch()
...
UPDATE song_masters
SET album_id = 'al-q3-wav-20260926', artist_id = (SELECT artist_id FROM song_masters WHERE id = '494'), album_artist_id = (SELECT album_artist_id FROM song_masters WHERE id = '494'), title = (SELECT title FROM song_masters WHERE id = '494'), sort_title = (SELECT sort_title FROM song_masters WHERE id = '494'), track = 4, disc = 1, genre = (SELECT genre FROM song_masters WHERE id = '494'), participants = (SELECT participants FROM song_masters WHERE id = '494'), lyrics = (SELECT lyrics FROM song_masters WHERE id = '494'), lyrics_rich = (SELECT lyrics_rich FROM song_masters WHERE id = '494'), cover_r2_key = (SELECT cover_r2_key FROM song_masters WHERE id = '494'), updated_at = unixepoch()
...
UPDATE song_masters
SET album_id = 'al-q3-wav-20260926', artist_id = (SELECT artist_id FROM song_masters WHERE id = '490'), album_artist_id = (SELECT album_artist_id FROM song_masters WHERE id = '490'), title = (SELECT title FROM song_masters WHERE id = '490'), sort_title = (SELECT sort_title FROM song_masters WHERE id = '490'), track = 6, disc = 1, genre = (SELECT genre FROM song_masters WHERE id = '490'), participants = (SELECT participants FROM song_masters WHERE id = '490'), lyrics = (SELECT lyrics FROM song_masters WHERE id = '490'), lyrics_rich = (SELECT lyrics_rich FROM song_masters WHERE id = '490'), cover_r2_key = (SELECT cover_r2_key FROM song_masters WHERE id = '490'), updated_at = unixepoch()
...
UPDATE song_masters
SET album_id = 'al-q3-wav-20260926', artist_id = (SELECT artist_id FROM song_masters WHERE id = '489'), album_artist_id = (SELECT album_artist_id FROM song_masters WHERE id = '489'), title = (SELECT title FROM song_masters WHERE id = '489'), sort_title = (SELECT sort_title FROM song_masters WHERE id = '489'), track = 7, disc = 1, genre = (SELECT genre FROM song_masters WHERE id = '489'), participants = (SELECT participants FROM song_masters WHERE id = '489'), lyrics = (SELECT lyrics FROM song_masters WHERE id = '489'), lyrics_rich = (SELECT lyrics_rich FROM song_masters WHERE id = '489'), cover_r2_key = (SELECT cover_r2_key FROM song_masters WHERE id = '489'), updated_at = unixepoch()
...
UPDATE song_masters
SET album_id = 'al-q3-wav-20260926', artist_id = (SELECT artist_id FROM song_masters WHERE id = '492'), album_artist_id = (SELECT album_artist_id FROM song_masters WHERE id = '492'), title = (SELECT title FROM song_masters WHERE id = '492'), sort_title = (SELECT sort_title FROM song_masters WHERE id = '492'), track = 8, disc = 1, genre = (SELECT genre FROM song_masters WHERE id = '492'), participants = (SELECT participants FROM song_masters WHERE id = '492'), lyrics = (SELECT lyrics FROM song_masters WHERE id = '492'), lyrics_rich = (SELECT lyrics_rich FROM song_masters WHERE id = '492'), cover_r2_key = (SELECT cover_r2_key FROM song_masters WHERE id = '492'), updated_at = unixepoch()
...
UPDATE albums
SET song_count = (SELECT COUNT(*) FROM song_masters sm WHERE sm.album_id=albums.id),
    duration = (SELECT COALESCE(SUM(sm.duration), 0) FROM song_masters sm WHERE sm.album_id=albums.id),
    ...
    updated_at = unixepoch()
WHERE id IN ('pending-uploads', 'al-q3-wav-20260926');

UPDATE albums
SET name = CASE WHEN
  song_count = (SELECT COUNT(*) FROM song_masters WHERE album_id='al-q3-wav-20260926')
  AND duration = (SELECT COALESCE(SUM(duration), 0) FROM song_masters WHERE album_id='al-q3-wav-20260926')
  AND size = (SELECT COALESCE(SUM(si.size), 0) FROM song_instances si JOIN song_masters sm ON sm.id=si.master_id WHERE sm.album_id='al-q3-wav-20260926')
  AND song_count = 9
  AND cover_r2_key IS (SELECT cover_r2_key FROM albums WHERE id='al-1a27548730')
  AND EXISTS (SELECT 1 FROM albums p WHERE p.id='pending-uploads'
    AND p.song_count = (SELECT COUNT(*) FROM song_masters WHERE album_id='pending-uploads')
    AND p.duration = (SELECT COALESCE(SUM(duration), 0) FROM song_masters WHERE album_id='pending-uploads')
    AND p.size = (SELECT COALESCE(SUM(si.size), 0) FROM song_instances si JOIN song_masters sm ON sm.id=si.master_id WHERE sm.album_id='pending-uploads'))
  THEN name ELSE NULL END,
  updated_at = unixepoch()
WHERE id='al-q3-wav-20260926';
