# Pending radio album identity audit

- [x] Reuse the idle worktree, preserve the prior branch, and create this branch from fetched `origin/main`.
- [x] Inspect both pending cohorts, source paths, ordering evidence, existing album links, and related editions using production-primary SELECTs only.
