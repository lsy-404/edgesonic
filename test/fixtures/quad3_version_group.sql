...
CREATE TABLE song_instances (id TEXT PRIMARY KEY, master_id TEXT NOT NULL, storage_object_id TEXT, suffix TEXT NOT NULL);
...
('sm-upload-b8fabd82-f0b','pending-uploads','unknown-artist',NULL,'01  -粉色柠檬',NULL,NULL,NULL,263,NULL,0,NULL,0,0,NULL,NULL,NULL),
...
('si-upload-b2b67d68-1e9','sm-upload-b8fabd82-f0b','obj_6f5f7eb6b38e540a','wav'),('si-upload-6f1bc3a4-0d1','sm-upload-14ec6786-592','obj_3e224dbf7ea72367','wav'),('si-upload-96edf67f-07d','sm-upload-55c19ccc-aa2','obj_01670fcda29a45b7','wav'),('si-upload-bddf767f-75e','sm-upload-820671c5-bbe','obj_28dec5d5e31a5385','wav'),('si-upload-a9d8a957-241','sm-upload-03ccb298-4a1','obj_bd32313e8b2d344b','wav'),('si-upload-265893d2-568','sm-upload-9a545ddf-565','obj_b5df9c696e9642db','wav'),('si-upload-ca5f8dd5-d54','sm-upload-dc94f069-0d2','obj_3e3105c88a8bd0f4','wav'),('si-upload-c2f0c37b-d5e','sm-upload-4bd88968-092','obj_2d695562524877fc','wav'),('si-upload-b0162f2a-e49','sm-upload-bf258535-10a','obj_f416b1299925a47d','wav');
