...
const checks: [string, boolean][] = [
  ...
  ["mobile navigation uses a native modal for background isolation", navigation.includes("<dialog") && navigation.includes(".showModal()")],
  ["mobile navigation closes with Escape", navigation.includes('@cancel.prevent="moreOpen = false"')],
