...
//  - The sidecar reader also recognizes `.ttml`, `.krc`, and `.elrc`. The
...
const SIDECAR_EXTS = [".ttml", ".krc", ".elrc", ".lrc"];
...
// Read a sibling rich-format sidecar (.ttml / .krc / .elrc / enhanced .lrc) and
...
// rich sidecar (.ttml / .krc / .elrc / enhanced .lrc) and writes its JSON payload to
